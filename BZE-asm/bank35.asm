...
.SECTION "Bank35" FORCE
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FDCFDF.l		; EF DF CF FD
	sbc $FFDFDB.l,X		; FF DB DF FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FF7FFF.l,X		; FF FF 7F FF
	sbc $FFDEFD.l,X		; FF FD DE FF
	xce		; FB
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $DFFBFF.l,X		; FF FF FB DF
	sbc $7FFFFF.l,X		; FF FF FF 7F
	sbc $EFFAFE.l,X		; FF FE FA EF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	xce		; FB
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	jsr ($DF7F.w,X)		; FC 7F DF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFDFFF.l,X		; FF FF DF FF
	sbc $FF7FDF.l,X		; FF DF 7F FF
	cmp $FF7FF7.l,X		; DF F7 7F FF
	sbc $FFFF7F.l,X		; FF 7F FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $EFFFFF.l,X		; FF FF FF EF
	...
	brk $00.b		; 00 00
	brk $41.b		; 00 41
	lsr $C8B3.w,X		; 5E B3 C8
	plp		; 28
	rti		; 40

	dec $8032.w,X		; DE 32 80
	asl A		; 0A
	tsb $28.b		; 04 28
	php		; 08
	sta ($00.b,X)		; 81 00
	...
	cmp $EFFFFB.l,X		; DF FB FF EF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	lda $DFFFBB.l,X		; BF BB FF DF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $EF7BDF.l,X		; FF DF 7B EF
	sbc $97FFF7.l,X		; FF F7 FF 97
	cmp [$DF.b],Y		; D7 DF
	sbc $FFFF.w,X		; FD FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	brk $41.b		; 00 41
	cli		; 58
	jsl $210420.l		; 22 20 04 21
	tsb $4162.w		; 0C 62 41
	rts		; 60

	stx $00.b		; 86 00
	jsl $40020A.l		; 22 0A 02 40
	tsb $00.b		; 04 00
	ora ($00.b,X)		; 01 00
	brk $01.b		; 00 01
	bpl   0.b		; 10 00
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $EFFFFF.l,X		; FF FF FF EF
	eor $EFFFDF.l,X		; 5F DF FF EF
	lda $FFEF7E.l,X		; BF 7E EF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $BFFFFF.l,X		; FF FF FF BF
	sbc $FDFBFF.l,X		; FF FF FB FD
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $7DFFDF.l,X		; FF DF FF 7D
	sbc $FFBFFF.l,X		; FF FF BF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $EEFFFF.l,X		; FF FF FF EE
	sbc $FFFECF.l,X		; FF CF FE FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFBDF.l,X		; FF DF FB FF
	sbc $FDFFFF.l,X		; FF FF FF FD
	...
	brk $00.b		; 00 00
	brk $18.b		; 00 18
	sta $1500.w,Y		; 99 00 15
	tay		; A8
	bcs 108.b		; B0 6C
	bpl   4.b		; 10 04
	jsl $020001.l		; 22 01 00 02
	brk $80.b		; 00 80
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	bpl   0.b		; 10 00
	...
	sbc $EEFDFF.l,X		; FF FF FD EE
	sbc $FF7FF5.l,X		; FF F5 7F FF
	sbc $FDFFFF.l,X		; FF FF FF FD
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFDDBF.l,X		; FF BF DD FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFB.l,X		; FF FB FF FF
	sbc $FFBDDF.l,X		; FF DF BD FF
	sbc $FFF77B.l,X		; FF 7B F7 FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFBFFF.l,X		; FF FF BF FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $D6FCFF.l,X		; FF FF FC D6
	sbc $FFFFFB.l,X		; FF FB FF FF
	cmp $FDFBFF.l,X		; DF FF FB FD
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FDFFFF.l,X		; FF FF FF FD
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	cpy $B0.b		; C4 B0
	bpl   9.b		; 10 09
	jsl $060C98.l		; 22 98 0C 06
	tsb $02.b		; 04 02
	tsb $00.b		; 04 00
	brk $00.b		; 00 00
	ora ($00.b),Y		; 11 00
	eor $2004.w,Y		; 59 04 20
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $DFAFEB.l,X		; FF EB AF DF
	sbc $FFEFFF.l,X		; FF FF EF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FEFFFF.l,X		; FF FF FF FE
	sbc $FFFF7F.l,X		; FF 7F FF FF
	jsr ($BFDF.w,X)		; FC DF BF
	sbc $FFFFDF.l,X		; FF DF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	cmp $FFFFFF.l,X		; DF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
...
.INDEX 8
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $DD77FF.l,X		; FF FF 77 DD
	sbc $7F7CDF.l,X		; FF DF 7C 7F
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	sbc $EFFFFF.l,X		; FF FF FF EF
	sbc $FFFDFF.l,X		; FF FF FD FF
	sbc $DFFF37.l,X		; FF 37 FF DF
	sbc $FBFFFF.l,X		; FF FF FF FB
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $BF3EFF.l,X		; FF FF 3E BF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	jsl $3028A2.l		; 22 A2 28 30
	ora $18.b,X		; 15 18
	and $1700.w,Y		; 39 00 17
	.db $82, $80, $0E		; 82 80 0E
	rti		; 40
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $DFFFFF.l,X		; FF FF FF DF
	sbc $77ADFF.l,X		; FF FF AD 77
	cmp $DFFFDD.l,X		; DF DD FF DF
	sbc $FFFF7F.l,X		; FF 7F FF FF
	sbc $DFF7FF.l,X		; FF FF F7 DF
	sbc $FFFFFF.l		; EF FF FF FF
	sbc $FFFFBF.l,X		; FF BF FF FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	ldx $F6BF.w,Y		; BE BF F6
	cmp [$F7.b],Y		; D7 F7
	sbc $DFFFEF.l,X		; FF EF FF DF
	sbc $FF7FFF.l,X		; FF FF 7F FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	adc $FAFFFF.l,X		; 7F FF FF FA
	sbc $FFFFBF.l,X		; FF BF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $D80200.l,X		; FF 00 02 D8
	lda #$14.b		; A9 14
	phx		; DA
	rol $0238.w,X		; 3E 38 02
	.db $42, $04		; 42 04
	cop $41.b		; 02 41
	brk $00.b		; 00 00
	jsr $0000.w		; 20 00 00
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	xce		; FB
	sbc $FF6EFF.l,X		; FF FF 6E FF
	sbc $F7FFFF.l,X		; FF FF FF F7
	lda $FFFBFD.l,X		; BF FD FB FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFEFF.l,X		; FF FF FE FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $0104FF.l,X		; FF FF 04 01
	eor $0B980E.l		; 4F 0E 98 0B
	tsb $09.b		; 04 09
	and $00.b		; 25 00
	bmi   2.b		; 30 02
	jsr $0104.w		; 20 04 01
	...
	brk $00.b		; 00 00
	brk $02.b		; 00 02
	ora $05A819.l		; 0F 19 A8 05
	lsr $20.b		; 46 20
	bvc  48.b		; 50 30
	jsl $000101.l		; 22 01 01 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $02.b		; 00 02
	brk $00.b		; 00 00
	...
	.db $1A		; Opcode 1A overrunning bank boundry at 23FFFF. Skipping.
.ENDS
